      ...
      <div class="container-fluid pokemon-card parent">
        <div id=${items[0].types[0].type.name} class="wrapper list-wrapper card shadow p-3 mb-5 bg-body-tertiary rounded ";>   
          ...
          <h1 id="pokemon-name">${items[0].name} </h1>
            ...
            <div id=${items[0].name} class="hp-div info-card-div" style="width:${items[0].stats[0].base_stat}%">HP: ${items[0].stats[0].base_stat}</div>
            <div id=${items[0].name} class="attack-div info-card-div" style="width:${items[0].stats[1].base_stat}%">Attack: ${items[0].stats[1].base_stat}</div>
            <div id=${items[0].name} class="defense-div info-card-div" style="width:${items[0].stats[2].base_stat}%">Defense: ${items[0].stats[2].base_stat}</div>
            <div id=${items[0].name} class="specialatk-div info-card-div" style="width:${items[0].stats[3].base_stat}%">Special-Attack: ${items[0].stats[3].base_stat}</div>
            <div id=${items[0].name} class="specialdef-div info-card-div" style="width:${items[0].stats[4].base_stat}%">Special-Defense: ${items[0].stats[4].base_stat}</div>
            <div id=${items[0].name} class="speed-div info-card-div" style="width:${items[0].stats[5].base_stat}%">speed: ${items[0].stats[5].base_stat}</div>
            <div id="plus-minus-div"><span>+</span></div>
          </div>
        </div>
     `
    listOutput.innerHTML += card
